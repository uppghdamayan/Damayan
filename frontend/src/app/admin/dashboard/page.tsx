...
function PaginatedListPanel({
  ...
  return (
    ...
    >
      <div className="bg-surface border border-border rounded-[10px] w-[620px] max-[1439px]:w-[540px] max-[767px]:w-[92vw] max-h-[82vh] flex flex-col shadow-modal">
        {/* Header */}
        <div className="flex items-center gap-2.5 px-[18px] py-3.5 border-b border-border flex-shrink-0">
          ...
          <h2 className="text-[15px] font-bold flex-1 text-text-primary">{title}</h2>
          <button
            onClick={onClose}
        ...
        {/* Search Bar */}
        <div className="px-[18px] pt-3 pb-2.5 flex-shrink-0 border-b border-border/40 bg-surface-2/50">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="sticky top-0 bg-surface-2 border-b border-border z-10">
                <th className="px-2.5 py-2 text-left text-[9px] font-bold uppercase tracking-[0.6px] text-text-secondary border-b border-border w-[60px]">
                  Rank
                </th>
                <th className="px-2.5 py-2 text-left text-[9px] font-bold uppercase tracking-[0.6px] text-text-secondary border-b border-border">
                  Name
                </th>
                <th className="px-2.5 py-2 text-left text-[9px] font-bold uppercase tracking-[0.6px] text-text-secondary border-b border-border w-[140px]">
                  Distribution
                </th>
                <th className="px-2.5 py-2 text-right text-[9px] font-bold uppercase tracking-[0.6px] text-text-secondary border-b border-border w-[100px]">
                  Count
                </th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="p-8 text-center text-[13px] text-text-muted">
                ...
                data.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-2.5 py-2 text-[12px] text-text-primary font-medium">
                        {item.name}
                      </td>
                      <td className="px-2.5 py-2">
                        <div className="w-full h-1.5 bg-surface-3 rounded-full overflow-hidden border border-border/40">
                      ...
                      <td className="px-2.5 py-2 text-[12px] font-bold text-text-primary font-mono text-right">
                        {item.count.toLocaleString()}
                      </td>
                    </tr>
                  );
...
export default function AnalyticsDashboardPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* ─── Paginated List Modals ──────────────────────────────────────── */}
      <PaginatedListPanel
        title="All Patient Diagnoses"
        endpoint="problems"
        dateRange={dateRange}
        open={showAllProblems}
        onClose={() => setShowAllProblems(false)}
      />
      <PaginatedListPanel
        title="All Prescribed Medications"
        endpoint="medications"
        dateRange={dateRange}
        open={showAllMedications}
