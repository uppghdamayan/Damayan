...
import type { ProblemLog } from '@/types/problem';
...
interface ProblemLogTableProps {
  logs: ProblemLog[];
  isLoading?: boolean;
}

export function ProblemLogTable({ logs, isLoading }: ProblemLogTableProps) {
              ...
              >
                ...
                <div className="flex justify-center">
                  <span className={cn(
                    ...
                    log.action === 'Renamed' ? "bg-blue-50 text-blue-600 border-blue-200 dark:bg-blue-900/20 dark:border-blue-900/30" :
